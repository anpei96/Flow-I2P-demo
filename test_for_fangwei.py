...
import numpy as np
from config_fangwei import make_cfg
from dataset_fangwei import test_data_loader
...
class Tester(SingleTester):
    ...
    def after_test_step(self, iteration, data_dict, output_dict, result_dict):
        ...
        base_path = "/media/anpei/DiskC/2d-3d-reg-work/codes/2D3DMATR-main/datasets/Fangwei/data/"
        save_path = "/media/anpei/DiskC/2d-3d-reg-work/codes/" + \
            "2D3DMATR-main/scene_plus/results/self/"
        import os
