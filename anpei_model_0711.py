...
from talk_net import talk_net
from histo_net import histo_net
...
class Diff2D3D(nn.Module):
    def __init__(self, cfg):
        ...
        self.talk_net   = talk_net()
        self.histo_net_0 = histo_net()
        self.histo_net_1 = histo_net()
        self.histo_net_2 = histo_net()
    ...
    def forward(self, data_dict):
        ...
        '''
            note-0524
            feature interaction layer --- talk-net

            in the fine-tuning stage, open the above code to train talk-net

            only using histo_net_0, histo_net_1, histo_net_2
        '''
        # img_feats_f, pcd_feats_f = \
        #     self.talk_net(data_dict, img_feats_f, pcd_feats_f)
        img_feats_f, pcd_feats_f = \
            self.histo_net_0(data_dict, img_feats_f, pcd_feats_f)
        img_feats_f, pcd_feats_f = \
            self.histo_net_1(data_dict, img_feats_f, pcd_feats_f)
        img_feats_f, pcd_feats_f = \
            self.histo_net_2(data_dict, img_feats_f, pcd_feats_f)
        # output_dict["mask_2d_pd"] = mask_2d_pd
        # output_dict["mask_3d_pd"] = mask_3d_pd
