...
class Tester(SingleTester):
    def __init__(self, cfg):
        ...
        '''
        note-0910:
            load model in test ---- rgbd scene
        '''
        base_path = "/media/anpei/DiskC/2d-3d-reg-work/codes/2D3DMATR-main/rgbd_plus/model_zoos/"
        ckpt_path = base_path + "flow-i2p.pth"
        # ckpt_path = base_path + "baseline.pth"
        self.load(ckpt_path)
