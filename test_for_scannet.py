...
import numpy as np
from config_scannet import make_cfg
from dataset_scannet import test_data_loader
...
class Tester(SingleTester):
    def __init__(self, cfg):
        ...
        ckpt_path = base_path + "epoch-15.pth"
    ...
    def after_test_step(self, iteration, data_dict, output_dict, result_dict):
        ...
        base_path = "/media/anpei/DiskC/2d-3d-reg-work/codes/2D3DMATR-main/datasets/Scannet/data/"
        save_path = "/media/anpei/DiskC/2d-3d-reg-work/codes/" + \
            "2D3DMATR-main/scene_plus/results/scannet/"
        import os
        ...
        if is_need_visulization:
            ...
            vis_rgb_pts_img_empty = vis_rgb_pts_img*1.0
            ...
            # extra
            # save_name = save_path + str(self.save_idx-1) + "_emp.png"
            # cv.imwrite(save_name, vis_rgb_pts_img_empty)
            # assert 1==-1
