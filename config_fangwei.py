...
_C.exp.output_dir = osp.join("/media/anpei/DiskC/2d-3d-reg-work/codes/2D3DMATR-main/scene_plus/", _C.exp.name)
...
# data
_C.data = edict()
_C.data.dataset_dir = "/media/anpei/DiskC/2d-3d-reg-work/codes/2D3DMATR-main/datasets/Fangwei"
...
_C.model.image_backbone.input_dim = 12 # 3
...
_C.model.point_backbone.input_dim = 4 # 3
