...
from spc_dataset import I2PHardPairDataset
from fangwei import FangWeiHardPairDataset
from scannet import ScanNetHardPairDataset

def train_valid_data_loader(cfg):
    train_dataset = ScanNetHardPairDataset(
    ...
    valid_dataset = ScanNetHardPairDataset(
        cfg.data.dataset_dir,
        "val",
...
def test_data_loader(cfg):
    ...
    test_dataset = ScanNetHardPairDataset(
        cfg.data.dataset_dir,
        "test",
        max_points=cfg.test.max_points,
        return_corr_indices=True,
